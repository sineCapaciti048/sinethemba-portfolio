# Sinethemba Mbatha - Professional Portfolio

**Aspiring Office Administrator**

Welcome to my professional portfolio website. This is a responsive, modern portfolio designed to showcase my skills, projects, and experience as an aspiring Office Administrator.
...
This portfolio website is designed to demonstrate my capabilities in:
- Administrative support and office management
- Document organisation and file management
- Data management and Excel proficiency
- Professional communication
- Project organisation and scheduling

The website is fully responsive and optimised for desktop, tablet, and mobile devices.

## 🛠️ Technical Stack

- **HTML5** — Semantic markup and structure
- **CSS3** — Responsive design, flexbox, and modern styling
- **JavaScript** — Interactivity, smooth scrolling, and form handling
